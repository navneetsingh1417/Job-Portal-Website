...
<a href="TotalEmployersApplied">Total Employers Applied</a>
</div>-->
<header>
		...
		<div class="row">			
			<ul class="main-nav">
				<li><a href="company-profile.jsp"><c:out value="${sessionScope.company_name }"></c:out></a></li>
		...
		<div class="hero">
			<h1><i>See</i></h1>
			<div class="button">
				<a href="TotalParticularJobs" class="btn btn-one">All Job Posted</a>
				<a href="TotalEmployersApplied" class="btn btn-two">Employers Applied</a>
			</div>
		</div>
